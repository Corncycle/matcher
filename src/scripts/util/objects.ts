...
import { basicMaterial, normalMaterial } from './materials'
...
export function createStaticBox(
  ...
  const boxMesh = new THREE.Mesh(cubeGeometry, normalMaterial)
  ...
  const boxBody = new CANNON.Body({ mass: 0, material: basicMaterial })
